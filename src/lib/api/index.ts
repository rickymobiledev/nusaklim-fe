 ...
 * `mock/*` langsung. Stasiun (`station-client.ts`) satu-satunya
 * implementasi — tidak ada varian lain buat domain ini. Domain lain
 * masih hardcode data contoh, tinggal buat `<domain>-client.ts` yang
 * implement interface yang sama lalu ganti baris di bawah begitu
 * kontrak backend-nya dikonfirmasi — hooks tidak perlu berubah sama
 * sekali.
 */
