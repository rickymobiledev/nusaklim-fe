...
export function mergeSeriesByDate(
  series: SolarRadiationStationSeries[],
): MergedChartRow[] {
 ...
 *  — dipakai tombol "Unduh Data" di `SolarRadiationFilters.tsx`. Kolom
 ...
 *  "null". */
export function buildRadiationCsv(series: SolarRadiationStationSeries[]): string {
