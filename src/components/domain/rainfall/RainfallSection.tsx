...
import {
  ...
  downloadChartImage,
  downloadCsvFile,
} from "@/lib/rainfall-chart-utils";
import { media } from "@/lib/breakpoints";
import { RainfallFilters } from "./RainfallFilters";
import { RainfallChart } from "./RainfallChart";
import { RainfallStationList } from "./RainfallStationList";
...
export function RainfallSection() {
  ...
  async function handleDownload(exportFormat: "csv" | "png" | "svg") {
    ...
    if (exportFormat === "csv") {
      const csv = buildRainfallCsv(coloredSeries);
    ...
    await downloadChartImage(
      ...
      `curah-hujan_${from}_${to}.${exportFormat}`,
      exportFormat,
    );
  }
