...
export function AirTemperatureSection() {
  ...
  // (lib/api/air-temperature-client.ts) — company dengan ratusan
  // stasiun bikin page load lambat. PENGECUALIAN cuma halaman ini; 6
  // halaman detail cuaca historis lain TETAP auto-pilih semua stasiun.
  ...
  function handleDownloadCsv(stationIds: string[]) {
    ...
    const csv = buildTemperatureCsv(selected);
