...
import { computeStationStats } from "@/lib/relative-humidity-chart-utils";
...
export function RelativeHumidityStationList({
  series,
  searchTerm,
  onSearchTermChange,
}: {
        ...
        {filtered.map((s) => {
          ...
          return (
            <StationCard key={s.stationId}>
              ...
              <AverageRow>
                <AverageLabel>Rata-Rata Kelembapan Relatif</AverageLabel>
                <AverageValue>
                  {stats.avg !== null ? stats.avg.toLocaleString("id-ID") : "--"}
                </AverageValue>
              </AverageRow>
              ...
              <MinMaxRow>
                <MinMaxBox>
                  ...
                  <MinMaxValue>
                    {stats.max !== null ? stats.max.toLocaleString("id-ID") : "--"}
                  </MinMaxValue>
                </MinMaxBox>
                <MinMaxBox>
                  <MinMaxLabel>Min</MinMaxLabel>
                  <MinMaxValue>
                    {stats.min !== null ? stats.min.toLocaleString("id-ID") : "--"}
                  </MinMaxValue>
                </MinMaxBox>
              </MinMaxRow>
            </StationCard>
