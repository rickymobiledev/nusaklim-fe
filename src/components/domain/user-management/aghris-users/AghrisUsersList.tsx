...
export function AghrisUsersList({
  users,
  onView,
  onEdit,
  onDelete,
        ...
        <Row key={user.id}>
          <FieldsGroup>
            ...
            <FieldCol>
              ...
              <FieldValue>{user.roleName}</FieldValue>
            </FieldCol>

            <FieldCol>
              <FieldLabel>Perusahaan</FieldLabel>
              <FieldValue>{user.companyName}</FieldValue>
            </FieldCol>
          </FieldsGroup>
...
/** Placeholder avatar generik Figma "media-image" — sama persis di
 *  `users/UsersList.tsx` (sengaja diduplikasi, pola icon inline domain ini). */
...
/** Mobile: kolom bertumpuk (identitas lalu Peran, Perusahaan — tombol ⋮
 *  di kanan atas kartu). Desktop: satu baris. */
