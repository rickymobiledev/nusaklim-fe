...
import { computeStationStats } from "@/lib/wind-speed-chart-utils";
...
export function WindSpeedStationList({
  series,
  searchTerm,
  onSearchTermChange,
}: {
        ...
        {filtered.map((s) => {
          ...
          return (
            <StationCard key={s.stationId}>
              ...
              <AverageRow>
                <AverageLabel>Rata-Rata Kecepatan Angin</AverageLabel>
                <AverageValue>{stats.avg ?? "--"}</AverageValue>
              </AverageRow>

              <MinMaxRow>
                <MinMaxBox>
                  <MinMaxLabel>Max</MinMaxLabel>
                  <MinMaxValue>{stats.max ?? "--"}</MinMaxValue>
                </MinMaxBox>
                <MinMaxBox>
                  <MinMaxLabel>Min</MinMaxLabel>
                  <MinMaxValue>{stats.min ?? "--"}</MinMaxValue>
                </MinMaxBox>
              </MinMaxRow>
            </StationCard>
          );
